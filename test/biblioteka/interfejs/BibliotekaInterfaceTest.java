...
public abstract class BibliotekaInterfaceTest {
	...
	void testVratiSveKnjige() {
		...
		java.util.List<Knjiga> knjige = biblioteka.vratiSveKnjige();
	...
	void testPronadjiKnjigu() {
		...
		java.util.List<Knjiga> rezultat = biblioteka.pronadjiKnjigu(null, null, "zung", null);
